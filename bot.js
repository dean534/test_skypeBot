        ...
        if (turnContext.activity.type === ActivityTypes.Message) {
            ...
            switch (message[1]) {
                ...
                case '普通登入':
                    ...
                    reply.attachments = [this.getInternetAttachment('普通登入的流程', 'image/jpg', 'http://ithelp.ithome.com.tw/upload/images/20141004/2014100423582554301921ad15f_resize_600.png')];
                ...
                case 'Token 登入':
                    ...
                    reply.attachments = [this.getInternetAttachment('Token 登入的流程', 'image/jpg', 'https://img.akanelee.me/20150515-1.jpg')];
